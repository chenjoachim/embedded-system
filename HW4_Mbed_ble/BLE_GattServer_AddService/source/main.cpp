...
const static char DEVICE_NAME[] = "GROUP7";
...
public:
    HeartrateDemo(BLE &ble, events::EventQueue &event_queue) :
        ...
        _magneto_uuid(GattService::UUID_MAGNETO_SERVICE),
        _magneto_x_value(100),
        _magneto_y_value(100),
        _magneto_z_value(100),
...
private:
    ...
    int16_t _magneto_y_value;
    int16_t _magneto_z_value;
